...
td {
    ...
    <div class="card">
        ...
        <div class="card-body">
          <h5 class="card-title">Selamat datang <b>{{session()->get('opr')}}</b> Operator Dokumen Humas</h5>
              ...
              <h2>
                ...
                <table class="table table-bordered datatable">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="hapusDokumenHumas/{{$isi->id}}" class="btn btn-danger">
                                Hapus
                            </a>
                ...
                <div class="modal fade" id="tambah" role="dialog">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <form action="simpanDokumenHumas" method="POST" enctype="multipart/form-data">
