      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
            ...
            <span class="d-none d-md-block dropdown-toggle ps-2">Info</span>
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="kelembagaan-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="{{asset('dokumen/KOSP_SMKN_6 JEMBER_2023_2024.pdf')}}" target="isinya">
                <i class="bi bi-circle"></i><span>Kurikulum operasional di satuan pendidikan(KOSP)</span>
            </a>
          </li>

		  <li>
            <a href="https://drive.google.com/embeddedfolderview?id=12lid02nN2JVM0425sIQVpU7Dp9AqKgHN#grid" target="isinya">
                <i class="bi bi-circle"></i><span>Penilaian Kinerja Guru(PKG)</span>
            </a>
          </li>

		  <li>
            <a href="https://drive.google.com/embeddedfolderview?id=1TNBVfBdK8nJ0bF_ANm-dHEAVIskFoPDr#grid" target="isinya">
                <i class="bi bi-circle"></i><span>Supervisi</span>
            </a>
          </li>

		  <li>
            <a href="{{asset('dokumen/b. Mengirim guru mengikuti kegiatan Upskilling.pdf')}}" target="isinya">
                <i class="bi bi-circle"></i><span>Peningkatan Kompetensi GTK</span>
            </a>
          </li>

		  <li>
            <a href="{{asset('dokumen/4.1.a Tefa.pdf')}}" target="isinya">
                <i class="bi bi-circle"></i><span>Teaching Factory(TEFA)</span>
            </a>
          </li>

		 <li>
            <a href="https://drive.google.com/embeddedfolderview?id=1nRGjju1D-0aR-PJP0Ws7c-rjsHTJjky3#grid" target="isinya">
                <i class="bi bi-circle"></i><span>BLUD</span>
            </a>
          </li>
      ...
      <li class="nav-item">
        ...
        <ul id="kbm-nav" class="nav-content collapse" data-bs-parent="#sidebar-nav">
            ...
            <li>
				...
				<a href="https://jurnalguru.smkn6jember.net/login.php" target="isinya">
                    <i class="bi bi-circle"></i><span>Rekap & Cetak Jurnal Guru</span>
                </a>
            </li>
        </ul>
      </li>
	  ...
	  <li class="nav-item">
        ...
        <ul id="portofolio-nav" class="nav-content collapse" data-bs-parent="#sidebar-nav">
          <li>
            ...
            <a href="https://drive.google.com/embeddedfolderview?id=1nvlCa2J5jauYRF-HyPp0CKvZ4pSu2sLp#list" target="isinya">
              <i class="bi bi-circle"></i><span>Desain Komunikasi Visual</span>
            </a>
            <a href="https://drive.google.com/embeddedfolderview?id=1pE6LpiYfcogEzYqd1LzrtBZ8rqNPndMd#list" target="isinya">
